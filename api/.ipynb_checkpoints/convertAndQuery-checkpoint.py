...
class Converter:
    ...
    def create_csv(actorsCol, mainVerbsCol, mainObjCol):
        ...
        return cleanedSet.to_csv('newUSSet.csv', sep=';', header=True, index=False)
    ...
    def main(file, heuristic_number):
        ...
        #csv_file = Converter.create_csv(actorsCol, mainVerbsCol, mainObjCol)
        return QueryGraph.main(heuristic_number)
