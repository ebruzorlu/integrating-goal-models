...
class QueryGraph:
    def create_db(graph):
        ...
        '''
        query = '''
                LOAD CSV WITH HEADERS FROM "file:///USSet.csv" AS row
                FIELDTERMINATOR ';'
    ...
    def main(heuristic_number):
        #TODO
        #heuristic number'a göre metod çalışacak.!!
        graph = Graph(ip_addr = "http://localhost:7474/browser", username = "tugce", password = "tugce")
